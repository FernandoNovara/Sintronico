...
public class RepositorioDetallePresupuesto : RepositorioBase, IRepositorioDetallePresupuestos
{
    public RepositorioDetallePresupuesto(IConfiguration configuration) : base(configuration) { }
